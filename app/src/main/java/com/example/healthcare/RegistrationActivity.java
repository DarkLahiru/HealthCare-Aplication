                        ...
                        mFirebaseAuth.createUserWithEmailAndPassword(email, pwd).addOnCompleteListener(RegistrationActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (!task.isSuccessful()) {
                                            ...
                                            rootReference.child(firebaseUser.getUid()).child("LoginDetails").setValue(myUserInsertObj)
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isComplete()) {
                                                                ...
                                                                finish();
                                                                rootReference.child(firebaseUser.getUid()).child("First Time Login").setValue("false");
